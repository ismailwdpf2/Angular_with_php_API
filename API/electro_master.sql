...
INSERT INTO `products` (`id`, `cat_id`, `brand_id`, `manufacturer_id`, `user_id`, `title`, `description`, `dimensions`, `weight`, `pprice`, `sprice`, `discount`, `quantity`, `options`, `created_at`) VALUES
